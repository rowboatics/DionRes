...
package com.polito.dion.Models;
...
public class Post {
    ...
    public Post(Author author, String full_url, String full_storage_uri, String thumb_url, String thumb_storage_uri,  String amount, String text, Object timestamp) {
        this.author = author;
